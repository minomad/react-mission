function Weather({ weather }) {
  return (
    <section className="flex min-h-[calc(100vh-52px)] flex-col items-center text-primary min-[500px]:min-w-[calc(100vh)]">
      ...
      <div className="my-2 flex justify-center px-[16px] pt-3 max-[500px]:flex-col ">
        {weather.map((weather) => (
          <div
            key={weather.datetime}
            className="flex flex-col items-center py-3 border-teal-800 px-4 max-[500px]:border-b"
          >
